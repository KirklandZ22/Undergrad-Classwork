...
// Block of code below checks if a user has a valid cookie and if not redirects back to login page.
// This is currently disabled as it is a production elements that does not work during local testing.
/* 
